...
module_param_string(mirrora, config, 256, 0);
MODULE_PARM_DESC(mirrora, " mirror=eth1[/eth2/eth3/...]@eth0 "
...
int inline is_ports (struct net_device *dev)
{
...
module_exit(acleanup_module);
module_init(ainit_module);
